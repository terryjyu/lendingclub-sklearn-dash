...
This is a cool project for utilizing Dash and Plotly as an interactive tool for investor data exploration and an alternative tool to give loan approval odds prediction of Lending Club.
